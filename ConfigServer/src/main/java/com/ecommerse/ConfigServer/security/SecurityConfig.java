package com.ecommerse.ConfigServer.security;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        UserDetails user1 = User.builder().username(username).password(this.bCryptPasswordEncoder().encode(password)).roles(new String[]{"ADMIN"}).build();
